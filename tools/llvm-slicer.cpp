...
llvm::cl::opt<bool> cutoff_diverging("cutoff-diverging",
    llvm::cl::desc("Cutoff diverging paths. That is, call abort() on those paths "
...
int main(int argc, char *argv[])
{
    ...
    if (cutoff_diverging) {
        ...
        auto csvalues = getSlicingCriteriaValues(*M.get(),
        ...
        if (!llvmdg::cutoffDivergingBranches(*M.get(), options.dgOptions.entryFunction, csvalues)) {
